...
public class DutyLegAggregatorHbDomTest extends DutyLegAggregatorTest {
    ...
    public void runTestProcedure()
    {
		 ...
		 * Add DOM to HB Leg.
		 */
		this.dutyRuleContext.getAggregatorProxy().append(d, dailyLegs[0].getHb1_Dom1ToHb1_1());	//	LocalDateTime.of(2014, Month.JANUARY, 1, 12, 30), LocalDateTime.of(2014, Month.JANUARY, 1, 14, 0), "320"));	//	DOM-IST	90
		 ...
		 *	Change Leg's state.
		 */
		dailyLegs[0].getHb1_Dom1ToHb1_1().setCover(false);
		...
		//	Revert
		dailyLegs[0].getHb1_Dom1ToHb1_1().setAcType("320");
		legRuleContext.getIntroducerProxy().introduce(dailyLegs[0].getHb1_Dom1ToHb1_1());
		dutyRuleContext.getAggregatorProxy().reCalculate(d);
    }
}
