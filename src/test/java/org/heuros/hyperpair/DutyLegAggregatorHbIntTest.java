 ...
 */
public class DutyLegAggregatorHbIntTest extends DutyLegAggregatorTest {
    ...
    public void runTestProcedure()
    {
		 ...
		 */
    	final Leg[] lHbDepIntArr = {dailyLegs[0].getHb1_Hb1ToInt1_1()};	//	LocalDateTime.of(2014, Month.JANUARY, 1, 11, 0), LocalDateTime.of(2014, Month.JANUARY, 1, 14, 0), "320"));	//	IST-INT	180

    	Duty d = HeurosDutyTestUtil.generateDutyInstance(lHbDepIntArr);
		 ...
		 * Add INT to HB leg.
		 */
		this.dutyRuleContext.getAggregatorProxy().append(d, dailyLegs[0].getHb1_Int1ToHb1_1());	//	LocalDateTime.of(2014, Month.JANUARY, 1, 14, 30), LocalDateTime.of(2014, Month.JANUARY, 1, 17, 40), "320"));//	INT-IST	190
