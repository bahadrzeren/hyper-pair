 ...
 */
public class DutyLegAggregatorDomIntTest extends AbsTestBase {
    ...
    public void runTestProcedure()
    {
		 ...
		 */
    	Leg l1 = this.generateLegInstance(101, apESB, apCDG,
		 ...
		 * DOM departed, INT arrival 1 Leg Duty.
		 */
		Leg l2 = this.generateLegInstance(101, apCDG, apIST, 
											LocalDateTime.of(2014, Month.JANUARY, 2, 0, 30), 
											LocalDateTime.of(2014, Month.JANUARY, 2, 3, 40), "320");	//	190
