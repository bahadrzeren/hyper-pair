 ...
 */
public class DutyLegAggregatorHbErTest extends AbsTestBase {
    ...
    public void runTestProcedure()
    {
		 ...
		 */
    	Leg l1 = this.generateLegInstance(101, apIST, apJFK,
...
//		assertFalse(d.isHard(hbNdxSAW));
		 ...
		 * Add ER to HB leg.
		 */
		Leg l2 = this.generateLegInstance(101, apJFK, apIST, 
